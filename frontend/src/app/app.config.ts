...
import { apiSecurityInterceptor } from './core/interceptors/api-security.interceptor';
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideHttpClient(withInterceptors([apiSecurityInterceptor, authInterceptor])),
